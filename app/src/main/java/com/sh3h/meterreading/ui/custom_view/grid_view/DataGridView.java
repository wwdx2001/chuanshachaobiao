package com.sh3h.meterreading.ui.custom_view.grid_view;
...
import com.sh3h.meterreading.ui.custom_view.grid_view.i18n.LangTextView;
...
public class DataGridView<T> extends LinearLayout implements View.OnClickListener{
    ...
    /**表头字体大小**/
    private float mHeaderTextSize = 15;
    /**表头背景**/
    ...
    public void initDataGridView(){
        if(colunmsWeight.length!=0){
            ...
            setRecyclerView(this.pageDatas, this.colunms, this.rowHeight, this.colunmsWeight, this.dividerSize, this.dividerColorResId,
              this.rvContentColorResId, this.selectedBackgroundColorResId, this.selectedMode,
              this.contentViewsClass, this.fieldNames, this.arrRadius, this.isFastAdd, this.mRowTextSize);
        }
    }
...
/*                TextView mTextView = new TextView(getContext());
                ...
                LayoutParams tvLayoutParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT);
                mTextView.setGravity(Gravity.CENTER_VERTICAL);
                mTextView.setTextSize(mHeaderTextSize);
                if(headerContent[i]!=null){
    ...
    private void setRecyclerView(List<Object> dataSource, int colunms, int rowHeight, float[] colunmsWeight, int dividerSize, int dividerColorResId, int rvContentColorResId, int selectedBackgroundResId, int setSelectedMode, Class[] contentViewsClass, String[] fieldNames, float[] radius, boolean isFastAdd, float rowTextSize) {
        mAdapter = new RecyclerviewAdapter(getContext(), dataSource, rowHeight, colunms, colunmsWeight, dividerSize, dividerColorResId, rvContentColorResId, selectedBackgroundResId, setSelectedMode, contentViewsClass, fieldNames, radius, isFastAdd, rowTextSize);
