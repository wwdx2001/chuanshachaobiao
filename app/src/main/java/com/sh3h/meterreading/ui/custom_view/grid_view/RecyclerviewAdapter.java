...
public class RecyclerviewAdapter extends RecyclerView.Adapter<RecyclerviewAdapter.RvViewHolder>{
    ...
    /**构造函数**/
    public RecyclerviewAdapter(Context context, List<Object> dataSource, int height, int colunms, float[] colunmsWeight, int dividerSize,
                               int dividerColorResId, int rvContentColorResId, int selectedBackgroundResId,
                               int selectedMode, Class[] contentViewsClass, String[] fieldNames,
                               float[] radius, boolean isFastAdd, float textSize) {
