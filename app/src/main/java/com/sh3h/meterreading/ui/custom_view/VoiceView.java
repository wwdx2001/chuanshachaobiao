...
public class VoiceView extends RadioButton implements View.OnTouchListener {
    ...
    public interface VoiceListener {
         ...
         * @param time     录音时长
         */
        void endRecord(String fileName, long time, VoiceItem voiceItem);
    }
...
//    private WindowManager mWindowManager;
    ...
    public void setVoiceItem(VoiceItem item) {
      this.mVoiceItem = item;
    ...
    private void actionUp() {
        ...
        if (mVoiceListener != null) {
            mVoiceListener.endRecord(mMultiMediaName, mRecordLength, mVoiceItem);
        }
...
//        mWindowManager = (WindowManager) mContext.getSystemService(Context.WINDOW_SERVICE);
        ...
        mParams = new RelativeLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT);
...
//        mParams.width = LinearLayout.LayoutParams.WRAP_CONTENT;
        ...
        dialog.addContentView(mImageView, mParams);
...
//            mMultiMediaName = mRecordLength + RECORD_FORMAT;
            mMultiMediaName = folder.getName();
            ...
            mMediaRecorder.setOutputFile(mPath);// 使用绝对路径进行保存文件
