...
public class OrderBackMultiMediaFragment extends ParentFragment implements ImagePickerAdapter.OnRecyclerViewItemClickListener, VoiceAdapter.OnRecyclerViewItemClickListener,
    ...
    public static OrderBackMultiMediaFragment newInstance(String param1, String param2) {
        OrderBackMultiMediaFragment fragment = new OrderBackMultiMediaFragment();
    ...
    protected int getLayoutId() {
        return R.layout.fragment_order_back_multi_media;
    }
    ...
    protected void initView1(View view) {
        ...
        mVideoAdapter = new ImagePickerAdapter(getActivity(), mVideoList, 1, Const.PHOTO_TYPE_VIDEO, Const.TYPE_VIDEO);
    ...
    private File createMediaFile() throws IOException {
        String path = Environment.getExternalStorageDirectory() + "/sh3h/taskmanager/video/";
        ...
        String imageFileName = "退单_" + timeStamp;
        String suffix = ".mp4";
            ...
            if (data != null) {
                ...
                if (url != null) {
                    ...
                    String vdeoThum = bitmap2File(getVideoThumbnail(url, 400,
                            400, MediaStore.Video.Thumbnails.MICRO_KIND),  System.currentTimeMillis() + "_退单_" + mRenwuId);
            ...
            if (position != Const.IMAGE_ITEM_ADD) {
                ...
                builder.setTitle("提示")
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                mVideoAdapter.getImages().remove(position);
                                mVideoAdapter.setImages(mVideoAdapter.getImages());
                            }
                        });
                AlertDialog dialog = builder.create();
                dialog.show();
        ...
        if (type == Const.PHOTO_TYPE_VIDEO) {
            if (position == Const.IMAGE_ITEM_ADD) {
                ...
                String OUTPUT_PATH = Environment.getExternalStorageDirectory()
                        + File.separator + "sh3h" + File.separator + "taskmanager"
                        + File.separator + "video" + File.separator
                        + System.currentTimeMillis() + "_退单_" + mRenwuId + ".mp4";
...
//                    startRecord();
    ...
    private File createVoiceFile() throws IOException {
        ...
        String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date());
        String imageFileName = timeStamp + "_退单_" + mRenwuId;
        String suffix = ".wav";
    ...
    public static String bitmap2File(Bitmap bitmap, String name) {
        File f = new File(Environment.getExternalStorageDirectory() + "/sh3h/taskmanager/video/" + name + ".jpg");
        if (f.exists()) {
            f.delete();
        }
        ...
        Observable.zip(observableList, new Function<Object[], List<String>>() {
            ...
            public void onNext(List<String> s) {
                ...
                if (isError && !StringUtils.isTrimEmpty(errorMsg)) {
                    ToastUtils.showShort("退单申请成功，文件上传失败：" + errorMsg);
                }
                if (!isError) {
                    callBack.onSuccess("退单申请成功，文件上传成功");
                }
