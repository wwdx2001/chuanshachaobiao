...
//	}
	...
	/**
	 * 转换JSONObject对象为JiChaRWEntity
	 *
	 * @param object
	 * @return
	 */
	public static JiChaRWEntity fromJSON(JSONObject object)
			throws JSONException {
		JiChaRWEntity cbrw = new JiChaRWEntity();
...
//		cbrw.setChaoBiaoZQ(object.optString("s_CHAOBIAOZQ"));
	...
	/**
	 * 转换JSONArray对象为List<JiChaRWEntity>
	 *
	 * @param array
	 * @return
	 * @throws JSONException
	 */
	public static List<JiChaRWEntity> fromJSONArray(JSONArray array)
			throws JSONException {
		List<JiChaRWEntity> list = new ArrayList<JiChaRWEntity>();
		for (int i = 0; i < array.length(); i++) {
			JSONObject object = array.getJSONObject(i);
			JiChaRWEntity cbsj = JiChaRWEntity.fromJSON(object);
			list.add(cbsj);
		}
		return list;
	}
