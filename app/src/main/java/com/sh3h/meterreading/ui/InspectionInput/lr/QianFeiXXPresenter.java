...
public class QianFeiXXPresenter extends ParentPresenter<QianFeiXXMvpView> {
  private static final String TAG = "LROperatingPresenter";
  private final PreferencesHelper mPreferencesHelper;
  private final ConfigHelper mConfigHelper;

  @Inject
  public QianFeiXXPresenter(DataManager dataManager, PreferencesHelper mPreferencesHelper, ConfigHelper mConfigHelper) {
    super(dataManager);
