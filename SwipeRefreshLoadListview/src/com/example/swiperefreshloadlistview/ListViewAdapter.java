...
public class ListViewAdapter extends BaseSwipeAdapter {
	...
	public View generateView(final int position, ViewGroup parent) {
		...
		// 添加删除布局的点击事件
		v.findViewById(R.id.trash).setOnClickListener(new OnClickListener() {
		...
		v.findViewById(R.id.trash1).setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View arg0) {
				Toast.makeText(mContext, "save"+position, Toast.LENGTH_SHORT).show();
				// 点击完成之后，关闭删除menu
				swipeLayout.close();
			}
		});
