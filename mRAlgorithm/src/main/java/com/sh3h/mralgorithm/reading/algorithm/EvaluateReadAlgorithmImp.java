 ...
 * @author liukaiyu
 */
public class EvaluateReadAlgorithmImp implements IReadAlgorithm {

    @Override
    public int getCode() {
        return IReadAlgorithm.ALGORITHM_EVALUATE;
    }
...
//        int bencicm = (entity.get_bencisl() / entity.get_shuibiaobeil())
