...
public class GalleryView extends Gallery {
    ...
    protected boolean getChildStaticTransformation(View child, Transformation trans) {
        ...
        //Math.abs(childCenter - mCoveflowCenter) < (child.getWidth() / 3)
        if (Math.abs(childCenter - mCoveflowCenter) < 95) {    // 正中间的childView\  rotationAngle = (int) (((float) (mCoveflowCenter - childCenter) / childWidth) * mMaxRotationAngle);
        ...
        Log.i("abc", "childCenter=" + childCenter);
        Log.i("abc", "child.getId()=" + child.getId());
        Log.i("abc", "-------------------------------");
        return true;
    }
