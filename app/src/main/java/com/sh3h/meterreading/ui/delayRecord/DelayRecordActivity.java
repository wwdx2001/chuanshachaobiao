...
public class DelayRecordActivity extends ParentActivity implements View.OnClickListener,
    ...
    private DelayRecordActivity.MyPagerAdapter mMyPagerAdapter;
...
//        }
        ...
        mMyPagerAdapter = new DelayRecordActivity.MyPagerAdapter(getSupportFragmentManager());
...
//        bundle.putString("PreActivity", mPreActivity);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (object instanceof DelayRecordLRFragment) {
                DelayRecordLRFragment recordLRFragment = (DelayRecordLRFragment) object;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.record_detail_info:
                ...
                intent.putExtra(CustomerInformationActivity.WHERE, 1);
...
//        outState.putInt(CeBenListActivity.DATA_TYPE, mDataType);
    ...
    private class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            Fragment fragment = new DelayRecordLRFragment();
