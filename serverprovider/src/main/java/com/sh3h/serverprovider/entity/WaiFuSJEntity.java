...
public class WaiFuSJEntity {
    ...
    private int I_CheckOutsideType;

    public WaiFuSJEntity() {

    }

    public WaiFuSJEntity(int _id,
                         int i_RenWuBH,
                         String _cH,
                         int _ceNeiXH,
                         String _cID,
        ...
        I_CheckOutsideType = i_CheckOutsideType;
    }
    ...
    public int getI_CheckOutsideType() {
        return I_CheckOutsideType;
    }

    public void setI_CheckOutsideType(int i_CheckOutsideType) {
        I_CheckOutsideType = i_CheckOutsideType;
    }
     ...
     * @return
     */
    public static WaiFuSJEntity fromJSON(JSONObject object) {
        WaiFuSJEntity cbsj = new WaiFuSJEntity();
        ...
        cbsj.setI_CheckOutsideType(object.optInt("i_CheckOutType"));
        return cbsj;
    }
     ...
     */
    public static List<WaiFuSJEntity> fromJSONArray(JSONArray array)
            throws JSONException {
        List<WaiFuSJEntity> list = new ArrayList<WaiFuSJEntity>();
        for (int i = 0; i < array.length(); i++) {
            JSONObject object = array.getJSONObject(i);
            WaiFuSJEntity cbsj = WaiFuSJEntity.fromJSON(object);
            list.add(cbsj);
        }
        return list;
    }
     ...
     * @return
     */
    public JSONObject toJSON(WaiFuSJEntity cbsj) throws JSONException {
        ...
        object.put("I_CheckOutType",cbsj.getI_CheckOutsideType());
        return object;
    }
    ...
    public JSONObject toJSON() throws JSONException {
        ...
        object.put("I_CheckOutType", getI_CheckOutsideType());
        return object;
    }
     ...
     * @return
     */
    public JSONArray toJSONArray(List<WaiFuSJEntity> list)
            throws JSONException {
        JSONArray array = new JSONArray();

        for (WaiFuSJEntity cbsjentity : list) {
