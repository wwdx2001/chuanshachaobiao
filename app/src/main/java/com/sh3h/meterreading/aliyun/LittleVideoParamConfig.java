...
public class LittleVideoParamConfig {
    ...
    public static class Recorder {
         ...
         */
        public static final int RESOLUTION_MODE = AlivcRecordInputParam.RESOLUTION_480P;
//        public static final int RESOLUTION_MODE = AlivcRecordInputParam.RESOLUTION_540P;
//        public static final int RESOLUTION_MODE = AlivcRecordInputParam.RESOLUTION_480P;
//        public static final int RESOLUTION_MODE = AlivcRecordInputParam.RESOLUTION_360P;

        /**
         * ratioMode: 纵横比, 9 : 16
         */
//        public static final int RATIO_MODE = AlivcRecordInputParam.RATIO_MODE_9_16;
        public static final int RATIO_MODE = AlivcRecordInputParam.RATIO_MODE_3_4;
         ...
         */
        public static final CameraType CAMERA_TYPE = CameraType.BACK;
...
//        public static final VideoQuality VIDEO_QUALITY = VideoQuality.LD;
         ...
         */
        public static final VideoCodecs VIDEO_CODEC = VideoCodecs.H264_SOFT_FFMPEG;

        /**
         * 录制视频保存路径
         */
        public static final String OUTPUT_PATH = Environment.getExternalStorageDirectory()
                + File.separator
