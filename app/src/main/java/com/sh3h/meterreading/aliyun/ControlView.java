...
public class ControlView extends RelativeLayout implements View.OnTouchListener {
    ...
    private LinearLayout mAlivcQualityResolution;
    private TextView mTvAspectRatio;
    private TextView mTvQualityResolution;
    private ImageView mIVAspectRatio;
    private ImageView mIVQualityResolution;
    //录制模式
    ...
    private int mResolutionMode = AliyunSnapVideoParam.RESOLUTION_480P;
    ...
    private void assignViews() {
        ...
        mAlivcQualityResolution = findViewById(R.id.alivc_record_change_quality_resolution_layout);
        mTvAspectRatio = findViewById(R.id.alivc_record_aspect_ratio_tv_change);
        mTvQualityResolution = findViewById(R.id.alivc_record_quality_resolution_change);
        mIVAspectRatio = findViewById(R.id.alivc_aspect_iv_ratio);
        mIVQualityResolution = findViewById(R.id.alivc_quality_resolution);
...
//        aliyunRecordProgress = (FanProgressBar) findViewById(R.id.aliyun_record_progress);
    ...
    private void setViewListener() {
        ...
        mAlivcQualityResolution.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (FastClickUtil.isFastClick()) {
                    return;
...
//                changeAspectRatio();
                ...
                if (mListener != null) {
                    mListener.onChangeQualityResolutioClick(mResolutionMode, mVideoQuality);
                }
...
//            mAlivcQualityResolution.setVisibility(VISIBLE);
            updateLightSwitchView();
            updateMusicSelView();
            updateCompleteView();
        } else {
...
//            mAlivcQualityResolution.setVisibility(GONE);
...
//            mTvMusic.setTextColor(ContextCompat.getColor(getContext(), R.color.alivc_record_color_filter));
            ...
            mIVQualityResolution.setColorFilter(ContextCompat.getColor(getContext(), R.color.alivc_record_color_filter), PorterDuff.Mode.MULTIPLY);
            mAlivcAspectRatio.setClickable(false);
            mAlivcQualityResolution.setClickable(false);
            mIVAspectRatio.setImageDrawable(ratioDrawable);
            mIVQualityResolution.setImageDrawable(ratioDrawable);
            mTvAspectRatio.setTextColor(ContextCompat.getColor(getContext(), R.color.alivc_record_color_filter));
            mTvQualityResolution.setTextColor(ContextCompat.getColor(getContext(), R.color.alivc_record_color_filter));
        } else {
...
//            mAlivcMusic.setClickable(true);
            ...
            mIVQualityResolution.clearColorFilter();
            mIVAspectRatio.setImageDrawable(ratioDrawable);
            mIVQualityResolution.setImageDrawable(ratioDrawable);
            mAlivcAspectRatio.setClickable(true);
            mAlivcQualityResolution.setClickable(true);
            mTvAspectRatio.setTextColor(ContextCompat.getColor(getContext(), R.color.alivc_common_font_white));
            mTvQualityResolution.setTextColor(ContextCompat.getColor(getContext(), R.color.alivc_common_font_white));
