...
public class RemoteinSpectionListAdapter extends RecyclerView.Adapter<RemoteinSpectionListAdapter.TaskHolder>  {
  public static final int TYPE_ITEM = 0;
  public static final int TYPE_STATUS = 1;
  public static final int TYPE_GUIJI = 2;
  private Context mContext;

  public RemoteinSpectionListAdapter(Context mContext) {
  ...
  public void setTaskList(List<BiaoKaBean> biaoKaBeans, List<BiaoKaListBean> biaoKaListBeans) {
    this.biaoKaBeans = biaoKaBeans;
  ...
  public void onBindViewHolder(TaskHolder holder, final int position) {
    ...
    holder.item.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        intent.putExtra(Const.IS_HISTORY, false);
