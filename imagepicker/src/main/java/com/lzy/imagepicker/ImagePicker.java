...
public class ImagePicker {
     ...
     * 拍照的方法
     */
    public void takePicture(boolean nbPhoto, String partName, String cameraType, String type, final Activity activity, int requestCode, String xiaoGenHao) {
        Log.e("prefix", "type=" + type + "    prefix=" + type);
...
//            if (Utils.existSDCard()) takeImageFile = new File(Environment.getExternalStorageDirectory(), "/DCIM/camera/");
            ...
            takeImageFile = createFile(nbPhoto, partName, cameraType, takeImageFile, type, ".jpg", xiaoGenHao);
    ...
    public static File createFile(boolean nbPhoto, String partName, String cameraType, File folder, String prefix, String suffix, String xiaoGenHao) {
...
//        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.CHINA);
        ...
        if (ImageGridActivity.CAMERA_TYPE_OCR_AFTER.equals(cameraType)
            ...
            filename = prefix + partName + suffix;
        } else {
            if (nbPhoto) {
...
//            filename = "test_"+prefix + System.currentTimeMillis() + suffix;
        }
        Log.e("fileName", "prefix=" + prefix + "   filename=" + filename);
