...
public class DUHuanBiaoJL implements IDUEntity {
    private String cid;
    private String biaoweixx;
    private String dengjir;
    private long dengjirq;
    private String huanbiaolx;
    private String huanbiaoyy;
    private String jiubiaobh;
    private String jiubiaogyh;
    private String jiubiaocj;
    private String xinbiaobh;
    private String xinbiaogyh;
    private String xinbiaocj;
    private String jiubiaoxh;
    private String xinbiaoxh;
    private String jiubiaokj;
    private String xinbiaokj;
    private int xinbiaolc;
    private int shangcicm;
    private int jiubiaocm;
    private int xinbiaodm;
    private long shigongrq;
    private String huitianr;
    private long huanbiaohtrq;
    private String huanbiaozt;
    private String beizhu;

    public DUHuanBiaoJL(String cid,
                        String biaoweixx,
                        String dengjir,
                        long dengjirq,
                        String huanbiaolx,
                        ...
                        String beizhu) {
        this.cid = cid;
        this.biaoweixx = biaoweixx;
        this.dengjir = dengjir;
        this.dengjirq = dengjirq;
        this.huanbiaolx = huanbiaolx;
        this.huanbiaoyy = huanbiaoyy;
        this.jiubiaobh = jiubiaobh;
        this.jiubiaogyh = jiubiaogyh;
        this.jiubiaocj = jiubiaocj;
        this.xinbiaobh = xinbiaobh;
        this.xinbiaogyh = xinbiaogyh;
        this.xinbiaocj = xinbiaocj;
        this.jiubiaoxh = jiubiaoxh;
        this.xinbiaoxh = xinbiaoxh;
        this.jiubiaokj = jiubiaokj;
        this.xinbiaokj = xinbiaokj;
        this.xinbiaolc = xinbiaolc;
        this.shangcicm = shangcicm;
        this.jiubiaocm = jiubiaocm;
        this.xinbiaodm = xinbiaodm;
        this.shigongrq = shigongrq;
        this.huitianr = huitianr;
        this.huanbiaohtrq = huanbiaohtrq;
        this.huanbiaozt = huanbiaozt;
        this.beizhu = beizhu;
    }
