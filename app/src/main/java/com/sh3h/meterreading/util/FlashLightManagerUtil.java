...
public class FlashLightManagerUtil {

    private static final String TAG = FlashLightManagerUtil.class.getName();
    ...
    private FlashLightManagerUtil() {
    }

    public FlashLightManagerUtil(Context context) {
    ...
    /**
     * 判断Android系统版本是否 >= LOLLIPOP(API23)
     *
     * @return boolean
     */
     ...
     *
     */
    public void turnLightOffCamera() {
        Camera.Parameters parameters = camera.getParameters();
        List<String> flashModes = parameters.getSupportedFlashModes();
        String flashMode = parameters.getFlashMode();
