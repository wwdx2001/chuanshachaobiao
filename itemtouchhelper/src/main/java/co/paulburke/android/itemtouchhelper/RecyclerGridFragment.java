...
package co.paulburke.android.itemtouchhelper;
...
public class RecyclerGridFragment extends Fragment implements OnStartDragListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final co.paulburke.android.itemtouchhelper.RecyclerListAdapter adapter =
                new co.paulburke.android.itemtouchhelper.RecyclerListAdapter(getActivity(), this);
