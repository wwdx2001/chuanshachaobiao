...
public class DUWaiFuCBSJ implements IDUEntity {
    ...
    private int checkOutsideType;

    public DUWaiFuCBSJ() {

    }

    public DUWaiFuCBSJ(int id,
                       int renwubh,
                       String ch,
                       int ceneixh,
                       String cid,
        ...
        this.checkOutsideType = checkOutsideType;
    }
    ...
    public int getCheckOutsideType() {
        return checkOutsideType;
    }

    public void setCheckOutsideType(int checkOutsideType) {
        this.checkOutsideType = checkOutsideType;
    }
}
