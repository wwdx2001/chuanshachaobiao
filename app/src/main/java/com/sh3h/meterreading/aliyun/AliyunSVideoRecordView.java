...
public class AliyunSVideoRecordView extends FrameLayout
    ...
    private com.aliyun.svideo.sdk.external.struct.recorder.CameraType cameraType
            = com.aliyun.svideo.sdk.external.struct.recorder.CameraType.BACK;
...
//                faceInitResult = recordView.faceUnityManager.createBeautyItem(mContext);
    ...
    private void initRecordTimeView() {
        ...
        LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT, SizeUtils.dp2px(6));

        params.setMargins(SizeUtils.dp2px(12),
                SizeUtils.dp2px(6),
                SizeUtils.dp2px(12),
                0);
    ...
    private void initControlView() {
        ...
        mControlView.setControlViewListener(new ControlViewListener() {
            ...
            @Override
            public void onChangeQualityResolutioClick(int mResolutionMode, VideoQuality mVideoQuality) {
                setQualityResolutio(mResolutionMode,mVideoQuality);
            }
        });
...
//            videoOutputPath = mMixVideoPath;
            recorder.setOutputPath(videoOutputPath);
...
//                    ToastUtils.show(recordView.getContext(), R.string.alivc_editor_publish_compose_failed);
     ...
     * 重新设置画质和视频质量
     */
    public void setQualityResolutio(int mResolutionMode, VideoQuality mVideoQuality) {
        this.mVideoQuality = mVideoQuality;
