...
public class ChaoBiaoSJEntity {
    ...
    private int I_GroupId;
    private int I_SortIndex;
    private String S_CardType;
    private int I_IsRead;
    private int I_ReasonUnRead;
    ...
    public ChaoBiaoSJEntity(int _id,
        ...
        this.I_SortIndex = I_SortIndex;
        this.S_CardType = S_CardType;
        this.I_IsRead = I_IsRead;
        this.I_ReasonUnRead = I_ReasonUnRead;
    ...
    /**
     * @param _ceNeiXH the _ceNeiXH to set
     */
    ...
    /**
     * @param _chaoBiaoN the _chaoBiaoN to set
     */
    ...
    /**
     * @param _chaoBiaoYue the _chaoBiaoYue to set
     */
    ...
    /**
     * @param _chaoCi the _chaoCi to set
     */
    ...
    /**
     * @param _chaoBiaoRQ the _chaoBiaoRQ to set
     */
    ...
    /**
     * @param _shangciCM the _shangciCM to set
     */
    ...
    /**
     * @param benCiCM the benCiCM to set
     */
    ...
    /**
     * @param _chaoJIanSL the _chaoJIanSL to set
     */
    ...
    /**
     * @param _zhaungTaiBM the _zhaungTaiBM to set
     */
    ...
    /**
     * @param _zhuangTaiMC the _zhuangTaiMC to set
     */
    ...
    /**
     * @param _shangciCBRQ the _shangciCBRQ to set
     */
    ...
    /**
     * @param _shangCiZTBM the _shangCiZTBM to set
     */
    ...
    /**
     * @param _shangCiZTMC the _shangCiZTMC to set
     */
    ...
    /**
     * @param _shangCiCJSL the _shangCiCJSL to set
     */
    ...
    /**
     * @param _shangCiZTLXS the _shangCiZTLXS to set
     */
    ...
    /**
     * @param _pingJunL1 the _pingJunL1 to set
     */
    ...
    /**
     * @param _pingJunL2 the _pingJunL2 to set
     */
    ...
    /**
     * @param _pingJunL3 the _pingJunL3 to set
     */
    ...
    /**
     * @param _zongBiaoCID the _zongBiaoCID to set
     */
    ...
    /**
     * @param _ChaoBiaoY the _ChaoBiaoY to set
     */
    ...
    /**
     * @param _chaoBiaoBZ the _chaoBiaoBZ to set
     */
    ...
    /**
     * @param _jiuBiaoCM the _jiuBiaoCM to set
     */
    ...
    /**
     * @param _xinBiaoDM the _xinBiaoDM to set
     */
    ...
    /**
     * @param _huanBiaoRQ the _huanBiaoRQ to set
     */
    ...
    /**
     * @param _fangShiBM the _fangShiBM to set
     */
    ...
    /**
     * @param _liangGaoLDYYBM the _liangGaoLDYYBM to set
     */
    ...
    /**
     * @param _chaoBiaoID the _chaoBiaoID to set
     */
    ...
    /**
     * @param _zhuangTaiLXS the _zhuangTaiLXS to set
     */
    ...
    /**
     * @param _shuiBiaoBL the _shuiBiaoBL to set
     */
    ...
    /**
     * @param _yongShuiZKL the _yongShuiZKL to set
     */
    ...
    /**
     * @param _paiShuiZKL the _paiShuiZKL to set
     */
    ...
    /**
     * @param _jianHao the _jianHao to set
     */
    ...
    /**
     * @param _xiaZaiSJ the _xiaZaiSJ to set
     */
    ...
    /**
     * @param _lingYongSLSM the _lingYongSLSM to set
     */
    ...
    /**
     * @param _liangGaoSL the _liangGaoSL to set
     */
    ...
    public int getI_GroupId() {
        return I_GroupId;
    }

    public void setI_GroupId(int i_GroupId) {
        I_GroupId = i_GroupId;
    }

    public int getI_SortIndex() {
        return I_SortIndex;
    }

    public void setI_SortIndex(int i_SortIndex) {
        I_SortIndex = i_SortIndex;
    }

    public String getS_CardType() {
        return S_CardType;
    }

    public void setS_CardType(String s_CardType) {
        S_CardType = s_CardType;
    }
    ...
    public int getI_ReasonUnRead() {
        return I_ReasonUnRead;
    }

    public void setI_ReasonUnRead(int i_ReasonUnRead) {
        I_ReasonUnRead = i_ReasonUnRead;
    }
    ...
    public static ChaoBiaoSJEntity fromJSON(JSONObject object) {
        ...
        cbsj.setI_GroupId(object.optInt("i_GroupId"));
        cbsj.setI_SortIndex(object.optInt("i_SortIndex"));
        cbsj.setS_CardType(object.optString("s_CardType"));
        cbsj.setI_IsRead(object.optBoolean("b_IsRead") ? 1 : 0);
        cbsj.setI_ReasonUnRead(object.optInt("i_ReasonUNRead"));
        cbsj.setI_SHANGGEDBZQTS(object.optInt("i_SHANGGEDBZQTS"));
        cbsj.setD_SHANGSHANGGYCBRQ(object.optLong("d_SHANGSHANGGYCBRQ"));
        return cbsj;
    }
    ...
    public JSONObject toJSON(ChaoBiaoSJEntity cbsj) throws JSONException {
        ...
        object.put("I_GroupId", cbsj.getI_GroupId());
        object.put("I_SortIndex", cbsj.getI_SortIndex());
        object.put("B_IsRead", cbsj.getI_IsRead() == 1);
        object.put("I_ReasonUNRead", cbsj.getI_ReasonUnRead());
        object.put("i_SHANGGEDBZQTS", cbsj.getI_SHANGGEDBZQTS());
        object.put("d_SHANGSHANGGYCBRQ", cbsj.getD_SHANGSHANGGYCBRQ());
        return object;
    }
    ...
    public JSONObject toJSON() throws JSONException {
        ...
        object.put("I_GroupId", getI_GroupId());
        object.put("I_SortIndex", getI_SortIndex());
        object.put("B_IsRead", getI_IsRead() == 0);
        object.put("I_ReasonUNRead", getI_ReasonUnRead());
        object.put("i_SHANGGEDBZQTS", getI_SHANGGEDBZQTS());
        object.put("d_SHANGSHANGGYCBRQ", getD_SHANGSHANGGYCBRQ());
        return object;
    }
