...
public class DURecord implements IDUEntity {
    ...
    public DURecord(int id,
        ...
        this.isRead = isRead;
        this.reasonUnRead = reasonUnRead;
    ...
    public int getReasonUnRead() {
        return reasonUnRead;
    }

    public void setReasonUnRead(int reasonUnRead) {
        this.reasonUnRead = reasonUnRead;
    }
