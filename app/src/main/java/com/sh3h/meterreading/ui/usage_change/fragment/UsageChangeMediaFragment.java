 ...
 * 实名制证件照
 */
public class UsageChangeMediaFragment extends ParentFragment implements ImagePickerAdapter.OnRecyclerViewItemClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_usage_change_upload_media;
    }
